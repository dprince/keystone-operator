...
// Generated by:
//
// operator-sdk create webhook --group keystone --version v1beta2 --kind KeystoneAPI --programmatic-validation --defaulting
//
...
//+kubebuilder:webhook:path=/mutate-keystone-openstack-org-v1beta2-keystoneapi,mutating=true,failurePolicy=fail,sideEffects=None,groups=keystone.openstack.org,resources=keystoneapis,verbs=create;update,versions=v1beta2,name=mkeystoneapi.kb.io,admissionReviewVersions=v1
...
func (r *KeystoneAPI) Default() {
	...
	if keystoneAPIDefaults.ContainerImageURL == "" {
		SetupKeystoneAPIDefaults(KeystoneAPIDefaults{
			ContainerImageURL: KeystoneAPIContainerImage,
...
func (spec *KeystoneAPISpecCore) Default() {
	// Initialize defaults if not already done
	if keystoneAPIDefaults.APITimeout == 0 {
		SetupKeystoneAPIDefaults(KeystoneAPIDefaults{
			ContainerImageURL: KeystoneAPIContainerImage,
			APITimeout:        APIDefaultTimeout,
		})
...
//+kubebuilder:webhook:path=/validate-keystone-openstack-org-v1beta2-keystoneapi,mutating=false,failurePolicy=fail,sideEffects=None,groups=keystone.openstack.org,resources=keystoneapis,verbs=create;update,versions=v1beta2,name=vkeystoneapi.kb.io,admissionReviewVersions=v1
